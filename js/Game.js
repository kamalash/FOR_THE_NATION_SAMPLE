class Game {
 ...
 play(){
  ...
  if(allPlayers !== undefined){
    ...
    handelSpawnEnemys(){
      if(frameCount % 100 == 0 ){
         enemy = createSprite(1200,random(50,550),40,40);
     ...
     handelSpawnLife(){
      if(frameCount % 1000 == 0 ){
         life = createSprite(1200,random(70,550),40,40);
     ...
     handelSpawnammo(){
      if(frameCount % 600 == 0 ){
         ammo = createSprite(1200,random(40,520),40,40);
      ...
      swal(
        {
          ...
          title: `Game Over!!!`,
          text: "Well Played Your Score Is " + player.score,
          imageUrl:
            "./assets/tankImg.png",
          imageSize: "150x150",
